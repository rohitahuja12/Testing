...
export default function Calibration() {
  ...
  const startCalibration = () => {
    ...
    console.log('calibrationProductId', calibrationProductId);
    console.log('defaultReaderSerialNumber', defaultReaderSerialNumber);
      ...
      <div className={classes.dashboardAppBackground}>
        <section className={classes.calibrationContainer}>
          ...
          <div className={classes.column}>
            <Paper mb={50}>
              <SubHeading centered>Calibration</SubHeading>
            ...
            {(isQueuedOrRunning || isComplete || isCancelled) && (
              <ProgressBar
                total={20}
                completed={isComplete ? 20 : 10}
                error={isCancelled}
                clickHandler={() => { setModalOpen(true) }}
                runningText={isCancelled ? 'calibration stopped' : 'estimated completion time 20 minutes'}
                completedText="calibration complete ✓"
                buttonText="Stop Calibration"
              />
            )}
