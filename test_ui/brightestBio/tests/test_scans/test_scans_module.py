...
#         record_property("testrail_result_comment", "3. Date column is visible.")
#         assert scans_page.is_status_column_visible()
#         record_property("testrail_result_comment", "4. Status column is visible.")
#         assert scans_page.is_id_column_visible()
#         record_property("testrail_result_comment", "5. ID column is visible.")
#         assert scans_page.is_name_column_visible()
#         record_property("testrail_result_comment", "6. Name column is visible.")
#
...
#         record_property("testrail_result_comment", "2. Navigate to the Scans module.")
#         scans_page.click_view_scan_option()
#         record_property("testrail_result_comment", "3. Click on Setting Button.")
#         scans_page.click_on_settings_button()
#         record_property("testrail_result_comment", "4. Uncheck ID checkbox.")
